...
public class MemberMgr {
	...
	public int chkStatus(String uId, String uPw) { 
	...
	// 회원 정보 가져오기
	public MemberBean getMemData(String id) {
		...
		try {
			...
			String sql = "select uId, uPw, uName, uEmail, uPhone, zipcode, address, faveFood";
