...
<body>
   <nav id="mainLNB">
		...
		<ul id="lnbMainMenu">		
		<!--  || gnbParam.equals("infoMod") --> 
    	<% if (gnbParam.equals("myPage")) {%>
			<li class="lnbMainLi"><a href="/mypage/orderList.jsp?gnbParam=myPage">주문내역</a></li>
            <li class="lnbMainLi"><a href="#">스크랩한 게시물</a></li>
            <li class="lnbMainLi"><a href="#">장바구니</a></li>
			<li class="lnbMainLi"><a href="/mypage/infoMod.jsp?gnbParam=myPage" >회원정보수정</a></li>
			<li class="lnbMainLi"><a href="/mypage/memberQuit.jsp?gnbParam=myPage">회원탈퇴</a></li>
    	...
    	<% } else if(gnbParam.equals("recipe")) {%>  		     		 
            <li class="lnbMainLi"><a href="/recipe/recipeList.jsp?gnbParam=recipe">메인요리</a></li>
    	...
    	<% } else if(gnbParam.equals("community")) { %>  		     		 
            ...
            <li class="gnbSubLi"><a href="/bbsFaq/faqList.jsp?gnbParam=community">1:1 문의 게시판</a></li>
